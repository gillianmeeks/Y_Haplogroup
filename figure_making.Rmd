...
all <- all[,c(1,8, 2,4,9,3,7,5,17,22,19,16,11,15,20,10,12,13,14,18,21,6)]
data(wrld_simpl)
...
geom_segment(aes(x=Bakax, y=Bakay, xend= 1, yend= -3), data=df)+
  ...
  geom_scatterpie(data=piechart_counts, aes(x=lon, y=lat, r = 7.8), cols= colnames(all), pie_scale = 1, legend_name = "Haplogroups") + coord_sf(xlim = c(-9, 56), ylim = c(-56, 18), expand = FALSE)+
  scale_fill_manual(labels = colnames(all), values = c('A1b (KHS)' = 'firebrick4', 'E1b1b1b2b (E. AFR)'= 'saddlebrown', 'A0a1a (Basal)'= 'grey', 'B2b (KHS)'='red3', 'E1b1b1b2a1 (KHS)'= 'orangered1', 'B2a (BAN)' = 'darkolivegreen4',  'E (BAN)' = 'darkgreen','C2e1b1 (E.ASN)' = 'lightgoldenrod', 'O (E. ASN)'='gold1','Q1a2 (E. ASN)'='yellow', 'K (S.E. ASN)'='hotpink', 'S (S.E. ASN)'='deeppink3', 'R2a (S. ASN)' = 'darkorchid4', 'L1a (S. ASN)'='darkmagenta', 'H1 (S. ASN)'= 'darkorchid1', 'H1a1d2c1b1a (EUR)'='blue3', 'I (EUR)'='blue1','J (EUR)'= 'cornflowerblue','G2a (EUR)' = 'navyblue','R1 (EUR)'='#59C7EB',  'T (EUR)'='#CCEEF9', 'CF'= 'black' )) + theme(legend.position = "bottom")+
  geom_text(aes(x=lon, y=lat-9.0, label=id), data=piechart_counts, fontface="bold")+
